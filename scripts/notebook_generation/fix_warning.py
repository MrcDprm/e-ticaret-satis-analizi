...
# Uyarıyı gideren güncellenmiş notebook
notebook = {
    "cells": [
        {
            "cell_type": "markdown",
...
# Notebook'u kaydet
notebook_path = "notebooks/04_sonuclar_uyari_giderilmis.ipynb"
with open(notebook_path, 'w', encoding='utf-8') as f:
    json.dump(notebook, f, indent=2, ensure_ascii=False)

print(f"Uyarı giderilmiş notebook başarıyla oluşturuldu: {notebook_path}")
